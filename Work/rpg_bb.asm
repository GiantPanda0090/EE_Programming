...
; 0x0063 P0   14 word(s)  0 % : init
; 0x0071 P0   10 word(s)  0 % : initserial
; 0x007B P0   27 word(s)  1 % : putchar
; 0x0096 P0   30 word(s)  1 % : getchar
; 0x00B4 P0   19 word(s)  0 % : delay10
; 0x00C7 P0  207 word(s) 10 % : printf
; 0x0018 P0   75 word(s)  3 % : main
; 0x0001 P0   23 word(s)  1 % : _const1

; RAM usage: 14 bytes (14 local), 242 bytes free
; Maximum call level: 2
;  Codepage 0 has  406 word(s) :  19 %
;  Codepage 1 has    0 word(s) :   0 %
; Total of 406 code words (9 %)
