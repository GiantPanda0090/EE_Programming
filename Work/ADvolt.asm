...
m002    BCF   0x03,RP0
        ...
        DECF  advalue+1,1
                        ...
                        ;      // and place the decimal comma correct
...
; 0x0072 P0    8 word(s)  0 % : initserial
; 0x0066 P0   12 word(s)  0 % : ADinit
; 0x007A P0   27 word(s)  1 % : putchar
; 0x0095 P0   22 word(s)  1 % : string_out
; 0x00AB P0  123 word(s)  6 % : longDecimal_out
; 0x0126 P0   22 word(s)  1 % : delay10
; 0x0010 P0   86 word(s)  4 % : main
; 0x0001 P0   15 word(s)  0 % : _const1

; RAM usage: 19 bytes (19 local), 237 bytes free
; Maximum call level: 2
;  Codepage 0 has  316 word(s) :  15 %
